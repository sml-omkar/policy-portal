...
<div class="dashboard">
    ...
    <div class="panel">
        ...
        <div class="table-wrap">
            ...
            <table>
                <thead><tr><th>Emp ID</th><th>Name</th><th>Email</th><th>Department</th><th>Status</th></tr></thead>
                <tbody id="tableBody">
                    ${pending.length ? renderRows(pending, true) : ''}
                    ${completed.length ? renderRows(completed, false) : ''}
                    ${!pending.length && !completed.length ? '<tr><td colspan="5" class="placeholder">No employees found.</td></tr>' : ''}
                </tbody>
            </table>
        </div>
    </div>
